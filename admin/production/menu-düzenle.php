        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="form-group">
                ...
                <input type="" id="first-name" name="menu_ad"  value="<?php echo $menucek['menu_ad'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="" id="first-name" name="menu_url"  value="<?php echo $menucek['menu_url'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea name="menu_detay" id="" cols="70" rows="5" value="<?php echo $menucek['menu_detay'] ?>"> </textarea>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="" id="first-name" name="menu_sira"  value="<?php echo $menucek['menu_sira'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
