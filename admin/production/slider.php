      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="clearfix"></div>
            <div align="right"><a href="slider-ekle.php"><button style="" class="btn btn-success btn-xs">Yeni Ekle</button></a> </div>
              ...
              <tbody>
                ...
                <td width="20"><?php echo $say ?></td>
                 ...
                 <?php }
                  ...
                  <td><center><a href="slider-düzenle.php?slider_id=<?php echo $slidercek['slider_id']; ?>"><button  class="btn btn-primary btn-xs">Düzenle</button></a></center></td>
