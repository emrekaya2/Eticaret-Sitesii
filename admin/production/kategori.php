      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            ...
            <div class="clearfix"></div>
            <div align="right"><a href="kategori-ekle.php"><button style="" class="btn btn-success btn-xs">Yeni Ekle</button></a> </div>
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <td><?php echo $say ?></td>
                  ...
                  <td><?php echo $kategoricek['kategori_durum'] ?></td>
                  <td align="center"><?php
                 ...
                 <?php }
                  ...
                  <td><center><a href="kategori-düzenle.php?kategori_id=<?php echo $kategoricek['kategori_id']; ?>"><button  class="btn btn-primary btn-xs">Düzenle</button></a></center></td>
